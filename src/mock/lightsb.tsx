...
//   return (
//     <div className="h-screen flex flex-col justify-between bg-gradient-to-b from-[#F8FAFC] to-[#E8EEF3] text-gray-800 border-r border-gray-200 shadow-sm">
//       {/* Logo Section */}
...
//           <p className="text-sm text-gray-500 px-2">No links for your role</p>
//         ) : (
...
//           className="flex items-center gap-3 w-full text-sm text-gray-600 hover:bg-gray-100 px-3 py-2 rounded-md transition"
//         >
